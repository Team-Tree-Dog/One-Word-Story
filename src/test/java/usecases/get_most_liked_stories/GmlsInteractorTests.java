...
public class GmlsInteractorTests {
    ...
    public void setup () {
        ...
        StoryRepoData sd1 = new StoryRepoData("text 1", authors, dt, 1);
        StoryRepoData sd2 = new StoryRepoData("text 2", authors, dt, 2);
        StoryRepoData sd3 = new StoryRepoData("text 3", authors, dt, 3);
