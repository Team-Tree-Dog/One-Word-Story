...
public class GatViewModel extends ResponseViewModel {
    private final Awaitable<List<TitleRepoData>> suggestedTitles = new Awaitable<>();
     ...
     */
    public Awaitable<List<TitleRepoData>> getSuggestedTitlesAwaitable() { return suggestedTitles; }
}
