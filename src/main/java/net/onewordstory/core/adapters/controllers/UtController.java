...
import net.onewordstory.core.adapters.presenters.UtPresenter;
import net.onewordstory.core.adapters.view_models.UtViewModel;
import net.onewordstory.core.usecases.upvote_title.UtInputBoundary;
import net.onewordstory.core.usecases.upvote_title.UtInputData;
