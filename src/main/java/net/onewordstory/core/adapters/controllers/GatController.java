...
import net.onewordstory.core.adapters.presenters.GatPresenter;
import net.onewordstory.core.adapters.view_models.GatViewModel;
import net.onewordstory.core.usecases.get_all_titles.GatInputBoundary;
import net.onewordstory.core.usecases.get_all_titles.GatInputData;
